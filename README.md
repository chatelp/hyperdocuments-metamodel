...
> La version courante du méta-modèle d'hyperscénario est disponible dans ce même projet GitHub. Il est à ouvrir avec l'outil [Papyrus pour Eclipse](https://eclipse.org/papyrus/).
